import { Home, Users, Target, ListChecks, FileText, BarChart3, UserCircle, LogOut, Package, BookOpen, Phone, Settings, UserCog, Calendar, DollarSign, ClipboardList, TrendingUp, File, Ticket, MessageSquare, StickyNote } from "lucide-react";
...
const productsItems = [
  ...
  { title: "Purchase Orders", url: "/dashboard/purchase-orders", icon: FileText },
...
const settingsItems = [
  ...
  { title: "Website Form Integration", url: "/dashboard/form-integration", icon: MessageSquare },
];
