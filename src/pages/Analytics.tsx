    ...
    <div className="space-y-4 md:space-y-6 p-2 md:p-0">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        <div>
          ...
          <p className="text-sm md:text-base text-muted-foreground">View detailed business insights</p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                <CardTitle className="text-base md:text-lg">Daily Sales Trend</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={250} className="md:h-[300px]">
                  <BarChart data={stats.dailyData.slice(-7)}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="date" />
                    <YAxis />
                    <Tooltip formatter={(value) => `₹${Number(value).toLocaleString()}`} />
            ...
            <Card className="md:col-span-2">
              <CardHeader>
                <CardTitle className="text-base md:text-lg">Daily Profit Trend</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={250} className="md:h-[300px]">
                  <LineChart data={stats.dailyData}>
